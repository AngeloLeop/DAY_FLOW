...
(function (root) {
  ...
  DF.storageService = {
    database: DF.db,
    configure(database) { if (!database || typeof database.open !== 'function' || typeof database.run !== 'function') throw new TypeError('Storage adapter must implement open() and run()'); this.database = database; return this; },
